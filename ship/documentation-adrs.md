...
**Phase:** Ship | **Complexity:** Beginner | **Duration:** 30 minutes - 2 hours (per ADR)
**Prerequisites:** None
...
- **Before:** [[../define/spec-driven-development]] - Decisions captured in specs
- **After:** [[shipping-launch]] - Document production readiness decisions

---

## Tools

- **ADR Tools:** adr-tools (command-line)
...
- **Why this matters:** [[./documentation-adrs/anti-rationalization]]
- **Common mistakes:** [[./documentation-adrs/pitfalls]]
- **Detailed examples:** [[./documentation-adrs/examples]]
