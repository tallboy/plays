...
- **Before:** [Context Engineering](context-engineering.md) - Document component conventions
- **During:** [Incremental Implementation](incremental-implementation.md) - Build components step-by-step
- **During:** [Test-Driven Development](../verify/test-driven-development.md) - Write tests for components
- **During:** [Browser Testing & DevTools](../verify/browser-testing-devtools.md) - Debug rendering issues
- **Review:** [Performance Optimization](../review/performance-optimization.md) - Optimize slow components
