...
- **Complements:** [Incremental Implementation](incremental-implementation.md) - Context ensures AI implements correctly
- **Complements:** [Test-Driven Development](../verify/test-driven-development.md) - Context defines test standards
- **Complements:** [Documentation & ADRs](../ship/documentation-adrs.md) - ADRs capture decisions, AGENTS.md captures conventions
