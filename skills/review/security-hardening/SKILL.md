...
description: "Apply security best practices to prevent OWASP Top 10 vulnerabilities. Use when auditing code, reviewing auth flows, or hardening production systems."
metadata:
  phase: review
  complexity: advanced
...
- **During:** [Code Review Quality](../code-review-quality/SKILL.md) - Security review in PR process
- **Before:** [Shipping & Launch](../../ship/shipping-launch/SKILL.md) - Security checklist before launch
