...
- **After:** [Test-Driven Development](../verify/test-driven-development.md) - Review tests alongside code
- **After:** [Security Hardening](security-hardening.md) - Deep security review
- **After:** [Performance Optimization](performance-optimization.md) - Performance review
- **Before:** [Git Workflow & Versioning](../ship/git-workflow-versioning.md) - Merge after approval
