...
- **Before:** [Idea Refinement](idea-refinement.md) or [Spec-Driven Development](spec-driven-development.md) - Get clear requirements first
- **After:** [Incremental Implementation](../build/incremental-implementation.md) - Execute the plan step-by-step
- **Parallel:** [Git Workflow & Versioning](../ship/git-workflow-versioning.md) - Each step becomes one commit
