...
description: "Transform vague ideas into clear, reviewable requirements before writing code. Use when requirements are incomplete, stakeholders are misaligned, or multiple interpretations exist."
metadata:
  phase: define
  complexity: beginner
...
- **Next Step:** [Spec-Driven Development](../spec-driven-development/SKILL.md) - Turn refined ideas into machine-readable specs
- **Alternative:** [Planning and Task Breakdown](../planning-and-task-breakdown/SKILL.md) - If requirements are already clear, skip to planning
- **Related:** [Documentation & ADRs](../../ship/documentation-adrs/SKILL.md) - Document decisions as Architecture Decision Records
