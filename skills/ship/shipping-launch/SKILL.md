...
description: "Comprehensive pre-launch checklist covering functionality, security, performance, observability, and operations. Use when deploying to production or launching features."
metadata:
  phase: ship
  complexity: advanced
...
- **Before:** [Security Hardening](../../review/security-hardening/SKILL.md) - Security review
- **Before:** [Performance Optimization](../../review/performance-optimization/SKILL.md) - Performance validation
- **Before:** [CI/CD Automation](../ci-cd-automation/SKILL.md) - Deployment automation
- **After:** [Documentation & ADRs](../documentation-adrs/SKILL.md) - Document launch decisions
