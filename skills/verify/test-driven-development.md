...
- **Before:** [Incremental Implementation](../build/incremental-implementation.md) - TDD integrates into each step
- **During:** [Browser Testing & DevTools](browser-testing-devtools.md) - E2E testing for UI
- **After:** [Code Review Quality](../review/code-review-quality.md) - Tests reviewed alongside code
