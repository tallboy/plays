...
description: "Systematic 5-step process for identifying, isolating, and fixing defects. Use when investigating bugs, handling errors, or troubleshooting production issues."
metadata:
  phase: verify
...
- **Uses:** [Browser Testing & DevTools](../browser-testing-devtools/SKILL.md) - Inspect and debug
- **Uses:** [Test-Driven Development](../test-driven-development/SKILL.md) - Write failing test first
- **After:** [Code Review Quality](../../review/code-review-quality/SKILL.md) - Review fix for quality
