...
**Phase:** Build | **Complexity:** Intermediate | **Duration:** 2-6 hours (per API design)
**Prerequisites:** [[../define/spec-driven-development]] - Clear requirements
...
- **Before:** [[../define/spec-driven-development]] - Spec the feature first
- **During:** [[incremental-implementation]] - Implement API endpoints
- **During:** [[../verify/test-driven-development]] - Write contract tests
- **Review:** [[../review/security-hardening]] - Validate auth/input
- **Ship:** [[../ship/documentation-adrs]] - Document API decisions

---

## Tools

- **Specification:** OpenAPI (Swagger), Stoplight Studio
- **Validation:** Schemathesis, Dredd, openapi-validator
...
- **Why this matters:** [[./api-and-interface-design/anti-rationalization]]
- **Common mistakes:** [[./api-and-interface-design/pitfalls]]
- **Detailed examples:** [[./api-and-interface-design/examples]]
