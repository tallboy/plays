...
description: "Implement features in small, verified increments. Each step is independently tested, committed, and traceable. Use as the default development approach for any codebase."
metadata:
  phase: build
  complexity: beginner
...
- All steps complete → [Git Workflow & Versioning](../../ship/git-workflow-versioning/SKILL.md)
...
- **Before:** [Planning and Task Breakdown](../../define/planning-and-task-breakdown/SKILL.md)
- **During:** [Test-Driven Development](../../verify/test-driven-development/SKILL.md)
- **After:** [Git Workflow & Versioning](../../ship/git-workflow-versioning/SKILL.md)
- **Context:** [Context Engineering](../context-engineering/SKILL.md)
