...
description: "Design APIs as products: define the interface before implementation, validate with contract tests. Use when designing REST/GraphQL APIs, SDKs, or service interfaces."
metadata:
  phase: build
...
- **Before:** [Spec-Driven Development](../../define/spec-driven-development/SKILL.md) - Spec the feature first
- **During:** [Incremental Implementation](../incremental-implementation/SKILL.md) - Implement API endpoints
- **During:** [Test-Driven Development](../../verify/test-driven-development/SKILL.md) - Write contract tests
- **Review:** [Security Hardening](../../review/security-hardening/SKILL.md) - Validate auth/input
- **Ship:** [Documentation & ADRs](../../ship/documentation-adrs/SKILL.md) - Document API decisions
