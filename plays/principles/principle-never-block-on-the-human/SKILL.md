...
- **Make the system self-healing.** When you notice a problem, log it and fix it in the next round. A defect outside your current diff, surfaced by the human's own aside rather than your own investigation, doesn't get "next round" — file it via **file-issue** before the reply ends. An aside is easy to let evaporate into a summary sentence precisely because it wasn't the thing you were asked to fix.
