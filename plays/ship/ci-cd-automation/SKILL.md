...
description: "Automate build, test, and deployment pipelines to catch issues early and deploy confidently. Use when setting up CI/CD, quality gates, or automated deployments."
metadata:
  phase: ship
...
- **Before:** [Git Workflow & Versioning](../git-workflow-versioning/SKILL.md) - Versioning triggers deployments
- **Uses:** [Test-Driven Development](../../verify/test-driven-development/SKILL.md) - Automated test execution
- **After:** [Shipping & Launch](../shipping-launch/SKILL.md) - Production deployment checklist
