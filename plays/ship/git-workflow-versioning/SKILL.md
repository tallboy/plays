...
description: "Structure git workflow for clear history, traceable releases, and semantic versioning. Use when managing branches, creating releases, or publishing packages."
metadata:
  phase: ship
  complexity: beginner
...
- **Before:** [Code Review Quality](../../review/code-review-quality/SKILL.md) - Review before merge
- **After:** [CI/CD Automation](../ci-cd-automation/SKILL.md) - Automated deployment
- **After:** [Shipping & Launch](../shipping-launch/SKILL.md) - Production deployment
