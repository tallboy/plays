...
description: "Capture architectural decisions with Architecture Decision Records. Use when choosing between technologies, patterns, or making significant design choices."
metadata:
  phase: ship
  complexity: beginner
...
- **Before:** [Spec-Driven Development](../../define/spec-driven-development/SKILL.md) - Decisions captured in specs
- **After:** [Shipping & Launch](../shipping-launch/SKILL.md) - Document production readiness decisions
