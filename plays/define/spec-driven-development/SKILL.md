...
description: "Write machine-readable specs before implementation to create a reviewable design contract. Use when building new features, making breaking changes, or shifting architecture."
metadata:
  phase: define
...
### 7. Implement
Link to [Planning and Task Breakdown](../planning-and-task-breakdown/SKILL.md) and [Incremental Implementation](../../build/incremental-implementation/SKILL.md)
...
- **Before:** [Idea Refinement](../idea-refinement/SKILL.md) - Clarify vague requirements first
- **After:** [Planning and Task Breakdown](../planning-and-task-breakdown/SKILL.md) - Break specs into work tracker
- **During:** [Incremental Implementation](../../build/incremental-implementation/SKILL.md) - Execute implementation
- **Finally:** [Documentation & ADRs](../../ship/documentation-adrs/SKILL.md) - Document architectural decisions
