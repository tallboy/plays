...
description: "Measure first, optimize second. Focus on the 80/20 rule — fix bottlenecks that impact users most. Use when profiling, load testing, or investigating slowdowns."
metadata:
  phase: review
...
- **Uses:** [Browser Testing & DevTools](../../verify/browser-testing-devtools/SKILL.md) - Profile and measure
- **After:** [Code Review Quality](../code-review-quality/SKILL.md) - Review optimization changes
- **Before:** [Shipping & Launch](../../ship/shipping-launch/SKILL.md) - Performance validated before launch
